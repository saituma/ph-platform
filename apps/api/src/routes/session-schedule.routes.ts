...
router.post(
  "/admin/scheduled-sessions/attendance/qr/generate",
  requireAuth,
...
router.patch(
  "/admin/session-templates/:templateId",
  requireAuth,
  requireRole(["coach", "admin", "superAdmin"]),
  rateLimiters.api,
  updateSessionTemplateAdmin,
...
router.patch(
  "/admin/scheduled-sessions/:sessionId",
  requireAuth,
  requireRole(["coach", "admin", "superAdmin"]),
  rateLimiters.api,
  updateScheduledSessionAdmin,
...
router.post(
  "/admin/scheduled-sessions/:sessionId/cancel",
  requireAuth,
  requireRole(["coach", "admin", "superAdmin"]),
  rateLimiters.api,
  cancelScheduledSessionAdmin,
...
router.get(
  "/admin/google-calendar/oauth/start",
  requireAuth,
  requireRole(["coach", "admin", "superAdmin"]),
  getGoogleCalendarOAuthStartAdmin,
);
...
router.get(
  "/admin/google-calendar/calendars",
  requireAuth,
  requireRole(["coach", "admin", "superAdmin"]),
  listGoogleCalendarsAdmin,
);
router.get(
  "/admin/google-calendar/events",
  requireAuth,
  requireRole(["coach", "admin", "superAdmin"]),
  listGoogleCalendarEventsAdmin,
);
router.post(
  "/admin/google-calendar/select",
  requireAuth,
  requireRole(["coach", "admin", "superAdmin"]),
  rateLimiters.api,
  selectGoogleCalendarAdmin,

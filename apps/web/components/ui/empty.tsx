...
function EmptyTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("cn-empty-title text-sm font-medium tracking-tight", className)}
      {...props}
    />
  )
}
...
function EmptyDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <div
      ...
      className={cn(
        "cn-empty-description text-muted-foreground text-sm/relaxed [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary",
        className
      )}
      {...props}
    />

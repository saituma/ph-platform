...
export function NativeSelect({
  ...
  return (
    <select
      className={cn(
        "relative inline-flex min-h-9 w-full min-w-36 select-none items-center rounded-lg border border-input bg-background px-3 text-base text-foreground shadow-xs/5 outline-none ring-ring/24 transition-shadow focus-visible:border-ring focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-64 sm:min-h-8 sm:text-sm",
        className,
      )}
      {...props}
    />

...
import { ADMIN_TAB_ROUTES } from "@/roles/admin/tabs";
import { ADMIN_TAB_COMPONENTS } from "@/roles/admin/tabComponents";
import { SHARED_TAB_COMPONENTS as BASE_SHARED_TAB_COMPONENTS } from "@/roles/shared/tabComponents";

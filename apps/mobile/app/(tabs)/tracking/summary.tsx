...
import { calculatePaceAndSpeed, estimateCalories, formatDistanceKm, formatDurationClock } from "../../../lib/tracking/runUtils";
...
export default function RunSummaryScreen() {
  ...
  const { paceMinPerKm: currentPace, speedKmH: currentSpeed } = calculatePaceAndSpeed(distanceMeters, elapsedSeconds);
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        <View style={{ alignItems: 'center', marginBottom: 32 }}>
          ...
          <Text style={{ fontFamily: fonts.heroDisplay, fontSize: 44, color: colors.text, letterSpacing: -1 }}>Run Complete!</Text>
        ...
        <View style={{ 
          ...
          <Text style={{ fontFamily: fonts.labelMedium, fontSize: 13, color: colors.textSecondary, marginTop: -8 }}>
            KILOMETERS
          </Text>
        </View>
        ...
        <View style={{ gap: 16 }}>
           ...
           >
              <Ionicons name={themeIcons.discard.name as any} size={20} color={colors.danger} style={{ marginRight: 8 }} />
              <Text style={{ fontFamily: fonts.heading3, fontSize: 16, color: colors.danger }}>Discard Run</Text>
           </Pressable>
        </View>
      </Animated.ScrollView>
    </SafeAreaView>

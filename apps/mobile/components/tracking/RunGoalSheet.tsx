...
export function RunGoalSheet({ visible, onClose, onConfirm }: RunGoalSheetProps) {
        ...
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined}>
          ...
          >
            ...
            {!showPicker && step === "destination" ? (
              <>
              <Text style={{ fontFamily: fonts.heading1, fontSize: 22, color: colors.text }}>
                Do you have a destination?
              </Text>
              <Text style={{ fontFamily: fonts.bodyMedium, fontSize: 14, color: colors.textSecondary, marginTop: 6 }}>
              ...
              <View style={{ marginTop: spacing.lg, gap: 12 }}>
                ...
                >
                  <Ionicons name={icons.route.name as any} size={18} color={colors.textPrimary} />
                ...
                >
                  <Text style={{ fontFamily: fonts.heading3, fontSize: 16, color: colors.textSecondary }}>
                    Skip
                  </Text>
                </Pressable>
              </View>
            ...
            {showPicker ? (
            <>
              <Text style={{ fontFamily: fonts.heading1, fontSize: 20, color: colors.text }}>
                Tap to drop a destination
              </Text>
              {isExpoGoAndroid ? (
                <Text style={{ fontFamily: fonts.bodyMedium, fontSize: 12, color: colors.textSecondary, marginTop: 4 }}>
                  Expo Go on Android may not render the map. You can still skip.
                </Text>
              ) : null}
              <View style={{ height: 240, borderRadius: radius.xl, overflow: "hidden", marginTop: spacing.md }}>
                <MapView
                  style={{ flex: 1 }}
              ...
              <View style={{ marginTop: spacing.lg, gap: 10 }}>
                ...
                >
                  <Text style={{ fontFamily: fonts.heading3, fontSize: 16, color: colors.textInverse }}>

...
export const IntroVideoPoster = React.memo(function IntroVideoPoster({ posterUrl, loading, replay, onPress }: { posterUrl: string | null; loading?: boolean; replay?: boolean; onPress: () => void }) {

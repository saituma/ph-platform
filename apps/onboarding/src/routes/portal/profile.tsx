			...
			>
				<Card className="border-2">
					...
					<CardContent className="flex items-center gap-6">
						...
						>
							<Avatar className="h-24 w-24 border-2 border-primary/20 transition-shadow group-hover:shadow-lg group-hover:shadow-primary/10">
					...
					<CardContent className="space-y-4">
						...
						<motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
							<Button
								...
								className="w-full h-12 rounded-xl font-bold uppercase italic tracking-wider"
							>
								{isSaving ? (

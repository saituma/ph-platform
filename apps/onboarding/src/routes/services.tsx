            ...
            <section className="pt-8 pb-16 max-w-6xl mx-auto px-5 sm:px-8 lg:px-10">
                ...
                >
                    ...
                    <h1 className="landing-section-heading text-foreground mb-4">
                        Everything you need to <span className="text-primary">perform</span>
                    </h1>
                ...
                <div className="max-w-6xl mx-auto px-5 sm:px-8 lg:px-10">
                    <div className="grid grid-cols-2 sm:grid-cols-4">
                        {DISCIPLINES.map((d, i) => (
                            <div
                                key={d.label}
                                className={`flex flex-col items-center gap-3 py-6 text-center ${i < DISCIPLINES.length - 1 ? "border-r border-border" : ""
                                    }`}
                            >
                                <d.icon
                                    size={28}
                ...
                <div className="space-y-12">
                    {SERVICES.map((service, i) => (
                        <motion.div
                            ...
                            className={`grid grid-cols-1 lg:grid-cols-2 gap-0 border border-border overflow-hidden ${i % 2 === 1 ? "lg:direction-rtl" : ""
                                }`}
                        >
                            {/* Image */}
                            <div
                            ...
                            {/* Content */}
                            <div
                                className={`p-8 lg:p-10 flex flex-col justify-center ${i % 2 === 1 ? "lg:order-1 lg:direction-ltr" : ""
                                    }`}
                            >
            ...
            <section className="border-t border-border py-16">
                <div className="max-w-2xl mx-auto px-5 text-center">
                    ...
                    <p className="text-[14px] text-muted-foreground leading-[1.7] mb-8">
                        Whether you're an individual athlete or a full squad, we have a
                        programme for you.
                    </p>
                    <Link
                        to="/register"

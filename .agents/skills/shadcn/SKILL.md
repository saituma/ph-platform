---
name: shadcn
description: Manage shadcn/ui components — add, search, fix, debug, style, and compose UI. Use when working with shadcn/ui, component registries, presets, or components.json.
user-invokable: true
---
